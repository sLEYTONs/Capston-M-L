...
-- Versión compatible con MariaDB/MySQL (sin IF NOT EXISTS en índices)
...
-- Nota: Si los índices ya existen, puedes comentar estas líneas o ignorar el warning
-- Descomenta solo si necesitas crear los índices adicionales
/*
