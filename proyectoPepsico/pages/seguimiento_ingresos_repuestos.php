...
<head>
    ...
    <title>Seguimiento de Ingresos de Repuestos - PepsiCo</title>
    <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css" rel="stylesheet">
    
    <?php include 'general/head.php'; ?>
    <link rel="stylesheet" href="../assets/css/repuestos-layout-shared.css">
    <link rel="stylesheet" href="seguimiento_ingresos_repuestos/css/seguimiento_ingresos.css">
</head>
...
<body data-pc-preset="preset-1" data-pc-sidebar-caption="true" data-pc-direction="ltr" 
    ...
    <div class="pc-container">
        <div class="custom-page-header" style="top: 60px; min-height: 60px !important; padding: 0.75rem 1rem !important; overflow: visible !important;">
            <div class="page-block" style="padding: 0 !important;">
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <h5 class="mb-1" style="margin-bottom: 0.25rem !important; line-height: 1.2 !important;">Seguimiento de Ingresos de Repuestos</h5>
                        <nav aria-label="breadcrumb" style="margin: 0 !important;">
                            <ol class="breadcrumb mb-0" style="margin: 0 !important; padding: 0 !important;">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Seguimiento de Ingresos</li>
                            </ol>
                        </nav>
                    </div>
                </div>
        ...
        <div class="pc-content" style="margin-top: 75px !important; padding-top: 0 !important;">
            <?php include 'seguimiento_ingresos_repuestos/components/c_seguimiento_ingresos.php'; ?>
        </div>
    </div>
    ...
    <script src="seguimiento_ingresos_repuestos/js/app.js"></script>
</body>
</html>
