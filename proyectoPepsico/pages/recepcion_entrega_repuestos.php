...
<head>
    ...
    <title>Recepción y Entrega de Repuestos - PepsiCo</title>
            ...
            <div class="page-header">
                <div class="page-block">
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <h5 class="mb-1">Recepción y Entrega de Repuestos</h5>
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="../index.php">Inicio</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Recepción y Entrega</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
