...
<head>
    ...
    <title>Comunicación con Proveedores - PepsiCo</title>
    ...
    <link rel="stylesheet" href="comunicacion_proveedores/css/comunicacion_proveedores.css">
</head>
...
<body data-pc-preset="preset-1" data-pc-sidebar-caption="true" data-pc-direction="ltr" 
    ...
    <div class="pc-container">
        <div class="custom-page-header" style="top: 60px; min-height: 60px !important; padding: 0.75rem 1rem !important; overflow: visible !important;">
            <div class="page-block" style="padding: 0 !important;">
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <h5 class="mb-1" style="margin-bottom: 0.25rem !important; line-height: 1.2 !important;">Comunicación con Proveedores</h5>
                        <nav aria-label="breadcrumb" style="margin: 0 !important;">
                            <ol class="breadcrumb mb-0" style="margin: 0 !important; padding: 0 !important;">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Comunicación Proveedores</li>
                            </ol>
                        </nav>
                    </div>
                </div>
        ...
        <div class="pc-content" style="margin-top: 75px !important; padding-top: 0 !important;">
            <?php include 'comunicacion_proveedores/components/c_comunicacion_proveedores.php'; ?>
        </div>
    </div>
    ...
    <script src="comunicacion_proveedores/js/app.js"></script>
</body>
</html>
