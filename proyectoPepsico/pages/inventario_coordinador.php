...
<head>
    ...
    <title>Inventario Actualizado - PepsiCo</title>
    <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css" rel="stylesheet">
    <?php include 'general/head.php'; ?>
    <link rel="stylesheet" href="inventario_coordinador/css/inventario_coordinador.css">
</head>
...
<body data-pc-preset="preset-1" data-pc-sidebar-caption="true" data-pc-direction="ltr" 
    ...
    <div class="pc-container">
        <div class="custom-page-header" style="top: 75px;">
            <div class="page-block">
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <h5 class="mb-1">Inventario Actualizado</h5>
        ...
        <div class="pc-content">
            <?php include 'inventario_coordinador/components/c_inventario_coordinador.php'; ?>
        </div>
    </div>
    
    <?php include 'general/footer.php'; ?>
    <?php include 'general/script.php'; ?>
    <script src="inventario_coordinador/js/app.js"></script>
</body>
</html>
